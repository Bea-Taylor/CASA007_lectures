...
Is cycling in London less safe since the introduction of Lime bikes?
...
*Two tailed:* if you care about the mean being different regardless of bigger or smaller
...
The mean height of female students is different to male students.  

[H0:]{style="color:#49a0c4"}  
The mean height of male and female students is the same  

[H1:]{style="color:#49a0c4"}  
The mean height of male and female students is different  
 <br>
...
Two-tailed test with $\alpha=0.5$. 
...
## Student's T-test: determine outcome 
...
```
In Python we can calculate the two-tailed critical t-value at $\alpha = 0.05$:
...
If $|t| > 1.972$, reject $H_0$

Our test statistic was $t \approx -12.7$ → $|-12.7| \gg 1.972$

**Conclusion:**
Reject $H_0$: male and female students have significantly different heights.
